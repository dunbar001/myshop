...
public class BrandController {
	...
	public PageResult search(@RequestBody TbBrand entity, int page, int rows) {
		return brandService.findPage(entity, page, rows);
	}
	...
	@RequestMapping("/findBrandSelectDatas")
	public List<Map> findBrandSelectDatas(){
		return brandService.findBrandSelectDatas();
	}
}
