...
import com.myshop.mapper.TbTypeTemplateMapper;
...
import com.myshop.pojo.TbTypeTemplateExample.Criteria;
import com.myshop.sellergoods.service.TypeTemplateService;
	...
	public PageResult findPage(TbTypeTemplate typeTemplate, int pageNum, int pageSize) {
		...
		private void saveToRedis(){
			...
			for(TbTypeTemplate item : list){
				...
				List<Map> specList = findSpecListById(item.getId());
